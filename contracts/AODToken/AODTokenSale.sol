...
contract AODTokenSale is Context, Pausable, AccessControlEnumerable, ReentrancyGuard {
    ...
    constructor(
        ...
        require(
            _maximumBUSDAmount > _minimumBUSDAmount,
            'Maximum BUSD amount should be greater than the minimum BUSD amount'
        );
    ...
    function release() public virtual nonReentrant {
        ...
        address(AOD).functionCall(
            abi.encodeWithSelector(AOD.mint.selector, beneficiary, releasable),
